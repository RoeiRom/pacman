...
public class Blinky extends Ghost {
	...
	{
		super("Blinky", board);
		Square init = playedBoard.getSquareBoard()[14][15];
	...
	public LinkedList<Vertex> pathFromAlgorithm() 
	{
		...
		LinkedList<Vertex> path = this.graph.Dijkstra(source, destination);
		path.removeFirst();
	...
	public void getOutOfStartPlace() 
	{
		...
		exitStart.add(new Vertex(14, 14));
		exitStart.add(new Vertex(13, 14));
		exitStart.add(new Vertex(12, 14));
		exitStart.add(new Vertex(11, 14));
	...
	protected void getIntoStartPlace(Vertex startVertex) 
	{
		...
		if (startVertex.getJ() == 13)
		{
			...
			enterStart.add(new Vertex(14, 15));
		}
		else
		{
