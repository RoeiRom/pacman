...
public class Pinky extends Ghost {
	...
	public Pinky(Board playedBoard) 
	{
		super("Pinky", playedBoard);
		Square init = playedBoard.getSquareBoard()[14][13];
	...
	public LinkedList<Vertex> pathFromAlgorithm() 
	{
		...
		LinkedList<Vertex> path = this.graph.BFS(source, destination);
		path.removeFirst();
